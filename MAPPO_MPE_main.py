...
class Runner_MAPPO_MPE:
    def __init__(self, args, env_name, number, seed):
        ...
        self.capture_rates = []  # For capture rates
        self.escape_rates = []  # For escape rates
        self.timeout_rates = []  # For timeout rates
        self.avg_capture_steps = []  # For average steps to capture
        self.actor_loss_history = []  # For actor loss
        self.critic_loss_history = []  # For critic loss
    ...
    def run(self, ):
        ...
        while self.total_steps < self.args.max_train_steps:
            ...
            if self.replay_buffer.episode_num == self.args.batch_size:
                ...
                self.loss_record_steps.append(self.total_steps)
                # 4. 记录到 TensorBoard
    ...
    def evaluate_policy(self, ):
        ...
        output_line = (
            ...
            f"平均奖励: {overall_avg_agent_reward:<5.2f} | "
    ...
    def run_episode_mpe(self, evaluate=False):
        ...
        # 在重置环境时，传入当前课程学习的场景ID
        # 如果是评估模式，不使用课程学习，而是采用默认场景或轮流测试
        if evaluate:
